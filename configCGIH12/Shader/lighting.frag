...
uniform Light light;  // Primera fuente
uniform Light light2; // Segunda fuente
uniform sampler2D texture_diffuse1;

void main()
{
    // Datos comunes para ambas luces
    ...
    // Multiplicamos el total de iluminación por el color de la textura
